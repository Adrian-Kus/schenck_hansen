...
function KostenUmTableTwoPhone() {
  return (
    <>
      <div className={tab.frame}>
        <table className={tab.table}>
          <caption className={tab.table__caption}>
            Was kostet ein Fernumzug ab Hamburg bis 45 m<sup>2</sup>?
          </caption>
          <thead>
      ...
      <div className={tab.frame}>
        <table className={tab.table}>
          <caption className={tab.table__caption}>
            Was kostet ein Fernumzug ab Hamburg bis 75 m<sup>2</sup>?
          </caption>
          <thead>
            <tr className={tab.data_row}>
              <th className={tab.th_left_top}>Wohnungsgröße</th>
      ...
      <div className={tab.frame}>
        <table className={tab.table}>
          <caption className={tab.table__caption}>
            Was kostet ein Fernumzug ab Hamburg bis 100 m<sup>2</sup>?
          </caption>
          <thead>
            <tr className={tab.data_row}>
              <th className={tab.th_left_top}>Wohnungsgröße</th>
      ...
      <div className={tab.frame}>
        <table className={tab.table}>
          <caption className={tab.table__caption}>
            Was kostet ein Fernumzug ab Hamburg bis 120 m<sup>2</sup>?
          </caption>
          <thead>
            <tr className={tab.data_row}>
              <th className={tab.th_left_top}>Wohnungsgröße</th>
...
export default KostenUmTableTwoPhone;
