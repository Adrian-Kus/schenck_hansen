...
function PrivatIntro() {
  return (
    <>
      <div className={int.frame}>
        <h2 className={int.frame__header}>
          Full-Service-Privatumzüge in Hamburg
        </h2>
        <h3 className={int.frame__subheader}>
          Wir bieten Ihnen mehr als nur einen Privat&shy;umzug
        </h3>
        <p className={int.frame__text}>
          Stellen Sie sich vor, Sie kommen von einem langen Arbeits&shy;tag nach
