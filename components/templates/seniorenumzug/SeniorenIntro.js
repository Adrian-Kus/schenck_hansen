    ...
    <>
      <div className={int.frame}>
        ...
        <p className={int.frame__text}>
          Wir sehen in unserem Senioren&shy;umzug nicht ein&shy;fach nur einen
          Um&shy;zug. Für uns geht es um mehr. Wir schaffen einen
          ganz&shy;heit&shy;lichen Service. Persön&shy;lich, emphatisch und mit
